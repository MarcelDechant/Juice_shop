...
You want to solve the tasks by yourself? [More Information](https://github.com/juice-shop/juice-shop)
...
1. **Lack of Protection Against Brute-Force or Credential Stuffing Attacks**:
...
1. **Insecure Password Recovery Mechanisms**:
...
1. Defend Against Credential Stuffing:
